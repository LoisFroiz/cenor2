...
<!--MOD PREFOOTER-->
		...
		<div class="prefooter-artenova">
			<div class="container_inner">
				<div class="two_columns_75_25 clearfix">
					<div class="text_wrapper column1">
						<h3>¿NECESITAS AYUDA? ENCUENTRA TU TIENDA CENOR</h3>
					</div>
					<div class="button_wrapper column2">
						<a class="prefooter-artenova__button" href="http://cenor2.artenovaclientes.es/tiendas/">VER MAS</a>
					</div>
				</div>
			</div>
		</div>
